...
const BoostFarm = () => {
  ...
  const [miningPowerList, setMiningPowerList] = useState([
    {
      title: "3x mining rig power",
      capacity: 3,
      cost: "1",
  ...
  useEffect(() => {
    setMiningPowerList(
      boostPowerLevels.map((item) => ({
        ...item,
        capacity: initialMiningPower * item.capacity,
      }))
    );
  }, [initialMiningPower, boostPowerLevels]);
      ...
      sendTransaction(transaction, {
        onSuccess: async (hash) => {
          ...
          await updateDoc(userRef, {
            boostedPower: newMiningPower,
          });
          setBoostedPower(newMiningPower);
              ...
              <span className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2 flex flex-col justify-center w-full text-center items-center space-x-1">
                <span className="flex items-center justify-center space-x-[2px] text-[18px]">
                  ...
                  <span className="text-accent">
                    +{selectedPower.capacity} PPS
                  </span>
                </span>
                <span>
                  Mining Rig Upgraded to {selectedPower.xx} Proft Per Hour
                </span>
              </span>
              <p className="pb-6 text-[15px] w-full text-center">
                Your new mining capacity is now activated and will start working
                for you! Good luck miner! 😎
              </p>
            </div>
          );
  ...
  return (
    <>
      <div className="w-full flex items-center justify-center px-3 pt-4">
        <button
              ...
              <div className="w-full flex taskbg rounded-tl-[40px] rounded-tr-[40px] mt-[2px] justify-center relative flex-col items-center space-y-3 p-4 pt-14 pb-10">
                ...
                <div className="w-full flex justify-center flex-col items-center">
                  ...
                  <div className="w-full flex flex-col space-y-2">
                    {miningPowerList.map((power, index) => (
                      <button
                        key={index}
              ...
              <div className="w-full flex taskbg rounded-tl-[40px] rounded-tr-[40px] mt-[2px] justify-center relative flex-col items-center space-y-3 p-4 pt-20 pb-10">
                ...
                <div className="w-full flex justify-center flex-col items-center">
                  ...
                  <p className="pb-6 text-primary text-[14px] px-4 text-center">
                    Boost your mining rig capacity to earn{" "}
                    {selectedPower.capacity} profit per hour!
                  </p>

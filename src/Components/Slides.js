...
const slides = [
  ...
  {
    title: `$${process.env.REACT_APP_PROJECT_SYMBOL} COMMUNITY`,
    description: "Join Bleggs community channel",
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto overflow-hidden">
      <div
        ...
        style={{
          transform: `translateX(-${(currentSlide % slides.length) * 90}%)`,
        }} // adjust 100% to 90% for partial view

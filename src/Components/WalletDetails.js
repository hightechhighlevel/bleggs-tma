...
export const Address = () => {
  ...
  useEffect(() => {
    if (!isAddressSaved || walletAddress !== address) {
  ...
  return (
    <>
      <div class="w-full rounded-[15px] bg-gradient-to-r from-[#457576bf] via-[#ef44ee] to-[#5c487d9e] p-[1px] flex flex-col justify-center relative">
        <button
          disabled={address}
          onClick={() => setOpenInfoTwo(true)}
          class="flex h-full w-full bg-[#319cdf] rounded-[14px] items-center py-3 px-4 relative space-x-3"
        >
          ...
          <div class="text-[13px] small-text2 text-left text-nowrap text-white pb-1 flex flex-col w-[73%]">
            {address ? (
              ...
              <>
                <h4 className="">Connect yout wallet</h4>
              </>
            )}
          </div>
          {address ? (
        ...
        {address && (
          <>
            <span
              onClick={disco}
              size={28}
              className="text-[#fff] cursor-pointer relative z-10"
            >
              Disconnect
            </span>
            ...
            >
              <p className="text-[#ffffff] pb-2">
                Are you sure you want to disconnect? Only connected wallets are
              ...
              <div className="w-full flex justify-center">
                <button
                  ...
                  className="font-medium bg-[#eb4848] w-fit rounded-[4px] px-2 py-1"
                >
                  Disconnect wallet
                </button>
              </div>
          ...
          <div className="w-full flex justify-center flex-col items-center space-y-3 pt-6">
            <div className="w-full items-center justify-center flex flex-col space-y-2">
              ...
              <p className="pb-6 text-[#bfbfbf] text-[14px] w-full text-center">
                Connect your crypto wallet. If you don't have one, create one in
